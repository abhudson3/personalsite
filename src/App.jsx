  ...
  return (
    <>
      ...
      <div className="welcome-page">
        ...
        <div className="welcome-page row">
          <div className="svgcon">
            <a href="https://www.linkedin.com/in/andrew--hudson/">
          ...
          <div className="svgcon">
            <a href="https://github.com/abhudson3">
      ...
      <Project
        ...
        tools={["VanillaJS", "MySQL", "C# Web API", "Bootstrap", "JQuery"]}
        image="https://i.imgur.com/m7PSZbP.png"
        alt="321 Group Project"
      ></Project>
      <Project
        color="#452e1a"
